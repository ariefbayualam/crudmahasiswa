        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="form-group">
                        ...
                        <input type="text" name="asal_sekolah" class="form-control" id="asal_sekolah" placeholder="asal_sekolah">
                    </div>
                    <div class="form-group">
                        <label for="no_hp">no_hp</label>
                        <input type="text" name="no_hp" class="form-control" id="no_hp" placehSolder="no_hp">
